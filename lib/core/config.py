...
class AppConfig:
    ...
    COOKIE_FILE = DATA_DIR / "moodle_uaa_cookies.pkl"
    ...
    _cp = os.getenv("COOKIES_PATH", str(DATA_DIR / "cookies.json"))
    GAI_COOKIES_PATH = Path(_cp) if Path(_cp).is_absolute() else DATA_DIR / _cp
